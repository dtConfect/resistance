...
class Magi(Bot):
    ...
    def calculateCurrentPlayerSuspicions(self):
        ...
        for o in self.otherPlayers:
            currentSuspicions[o.name] = 0.0

        # Loop through the player assignments and calculate the total probability that each individual player is a spy
        for pa in self.hmms:
            for s in pa.spies:
                currentSuspicions[s.name] += pa.probability
    ...
    def onGameComplete(self, win, spies):
        ...
        #print("Magi suspicion statistics: ")
